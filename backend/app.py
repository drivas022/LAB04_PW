...
app.config["SQLALCHEMY_DATABASE_URI"] = "sqllite:///songs.db" # URI de la base de datos, sqllite es un motor de base de datos liviano que guarda todo en un archivo local llamado songs.db
